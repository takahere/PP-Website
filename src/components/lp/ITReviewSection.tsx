...
export function ITReviewSection() {
  return (
    <section className="py-8 sm:py-12" aria-labelledby="itreview-heading">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 bg-white rounded-2xl p-6 sm:p-8 lg:p-10">
          ...
          <div className="w-40 sm:w-48 lg:w-56 flex-shrink-0">
            <Image
              src="https://partner-prop.com/wp-content/themes/partnerprop/assets/img/icon_itreview.png"
              alt="ITreview"
              width={655}
              height={323}
          ...
          <div className="w-32 sm:w-40 lg:w-48 flex-shrink-0">
            <Image
              src="https://partner-prop.com/wp-content/themes/partnerprop/assets/img/img_itreview_rader_chart.png"
